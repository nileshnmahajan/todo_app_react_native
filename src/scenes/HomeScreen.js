      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => this.markAsDone(label, item)}></TouchableOpacity>
        </View>
      </View>
    );
  };
          ...
          {this.state.data.length == 0 && (
            <View
              ...
              <Button
                ...
                onPress={() => navigation.navigate(this, 'newToDoScreen')}>
                Add new task
              </Button>
            </View>
          )}
